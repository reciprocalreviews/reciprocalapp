...
- [x] Mirror a **narrow, review-relevant slice** of the scholar's public ORCID record: current affiliation (role, department, organization), self-declared keywords, the five most recent works with a count and year span over all of them, most recent education, and outbound links. This reverses an earlier decision to mirror nothing and link out for everything, and the reason is the assigner: an editor choosing a reviewer was opening orcid.org in another tab to answer "who is this person and do they work on this?", and RR knew the iD all along. The slice is **scoped rather than open-ended** — RR is not becoming a profile host, and everything outside it still lives at the other end of the link.
